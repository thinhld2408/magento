...
class SM_MegaMenu_Model_Resource_Menu extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('sm_megamenu/menu', 'menu_id');
    }
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $table  = $this->getTable('sm_megamenu/menu_store');
    ...
    public function getIsUniqueMenuToStores(Mage_Core_Model_Abstract $object)
    {
        ...
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('menu_stores' => $this->getTable('sm_megamenu/menu_store')),
    ...
    public function lookupStoreIds($id)
    {
        ...
        $select  = $adapter->select()
            ->from($this->getTable('sm_megamenu/menu_store'), 'store_id')
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('menu_store' => $this->getTable('sm_megamenu/menu_store')),
